...
// SELLER menu to ADD, REMOVE, ADD CATEGORY, REMOVE CATEGORY, or LOGOUT
function sellerMenu() {
    while (true) {
        console.log("\nSELLER Options: ");
...
// Function to remove an item from a category (A.5)
function removeCategory() {
    ...
    const categoryChoice = prompt("Enter the category name to remove an item from:").trim();
    if (!categories[categoryChoice]) {
        console.log("Invalid category. Please try again.");
        return;
    }
